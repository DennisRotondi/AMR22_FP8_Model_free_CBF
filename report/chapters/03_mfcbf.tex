\section{Model Free Safety-Critical Control}
...
\subsection{Importance of disturbances}
...
\begin{equation} \label{eq:s vd}
    ...
    \end{split}
\end{equation}
Theorem \ref{th:issf} shows that ISSf is guaranteed by ISS tracking. %$||\dot{\ev}(t)|| \leq M ||\dot{\ev}_0|| e^{-\lambda t}+\mu(||\dv||_\infty)$. 
